    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, Homepage.class);
        ...
        newComic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, CreateNewComic.class);
                startActivity(intent);
            }
        });
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, Search.class);
                startActivity(intent);
            }
        });
        ...
        notifications.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, Notifications.class);
                startActivity(intent);
            }
        });
        ...
        challenges.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, ComicChallenge.class);
                startActivity(intent);
            }
        });
        ...
        collaboration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, Collaboration.class);
                startActivity(intent);
            }
        });
        ...
        templates.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, Templates.class);
                startActivity(intent);
            }
        });
        ...
        remix.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomepageDrawer.this, RemixComic.class);
                startActivity(intent);
            }
        });

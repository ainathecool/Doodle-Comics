...
public class NotificationsDrawer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, Notifications.class);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, Homepage.class);
                startActivity(intent);
            }
        });
        ...
        newComic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, CreateNewComic.class);
                startActivity(intent);
            }
        });
        ...
        search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, Search.class);
                startActivity(intent);
            }
        });
        ...
        challenges.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, ComicChallenge.class);
                startActivity(intent);
            }
        });
        ...
        collaboration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, Collaboration.class);
                startActivity(intent);
            }
        });
        ...
        templates.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, Templates.class);
                startActivity(intent);
            }
        });
        ...
        remix.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(NotificationsDrawer.this, RemixComic.class);
                startActivity(intent);
            }
        });
